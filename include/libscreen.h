 ...
 * @brief Area
 *
 * This struct stores all the information related to an Area
 */
 ...
 * @brief Frame_color
 *
 * This enum defines the type of variable Frame_color. Its posible values BLUE, GREEN, BLACK, RED, YELLOW, PURPLE, CYAN and WHITE.
 */
